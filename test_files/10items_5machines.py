...
if __name__ == '__main__':
    ...
    experiment_name = '10items_5machines' # we set the experiment using the available files in cfg
    ...
    training_epochs_multiagent = 15000
    ...
    base_rl_agent.model_name = base_model_name
