...
if __name__ == '__main__':
    ...
    experiment_name = '40items_20machines' # we set the experiment using the available files in cfg
    ...
    second_agent = stoch_agent
    second_agent.model_name = "RP"
    setting_sol_method['multiagent'] = True
    setting_sol_method['dict_obs'] = True
    settings['dict_obs'] = setting_sol_method['dict_obs']
    ...
    #ensemble_agent.learn(training_epochs_multiagent)
