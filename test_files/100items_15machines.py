...
if __name__ == '__main__':
    ...
    experiment_name = '100items_15machines' # we set the experiment using the available files in cfg
    ...
    training_epochs_RL = 5000
    training_epochs_multiagent = 1000
    ...
    ensemble_agent.learn(int(training_epochs_multiagent/10))
